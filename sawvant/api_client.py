...
from sawvant.api_response import ApiResponse, T as ApiResponseT
import sawvant.models
from sawvant import rest
from sawvant.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sawvant.models, klass)
